...
class QAbstractPrintDialog(QtWidgets.QDialog):
    ...
    class PrintDialogOptions(enum.Flag):
        PrintToFile = ... # type: QAbstractPrintDialog.PrintDialogOptions
        PrintSelection = ... # type: QAbstractPrintDialog.PrintDialogOptions
        PrintPageRange = ... # type: QAbstractPrintDialog.PrintDialogOptions
        PrintCollateCopies = ... # type: QAbstractPrintDialog.PrintDialogOptions
        PrintShowPageSize = ... # type: QAbstractPrintDialog.PrintDialogOptions
        PrintCurrentPage = ... # type: QAbstractPrintDialog.PrintDialogOptions
...
class QPrintDialog(QAbstractPrintDialog):
    ...
    def testOption(self, option: QAbstractPrintDialog.PrintDialogOptions) -> bool: ...
    def setOption(self, option: QAbstractPrintDialog.PrintDialogOptions, on: bool = ...) -> None: ...
    def done(self, result: int) -> None: ...
    def exec(self) -> int: ...
...
class QPrintPreviewDialog(QtWidgets.QDialog):
    ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtWidgets.QWidget] = ..., flags: QtCore.Qt.WindowFlags = ...) -> None: ...
    @typing.overload
    def __init__(self, printer: QPrinter, parent: typing.Optional[QtWidgets.QWidget] = ..., flags: QtCore.Qt.WindowFlags = ...) -> None: ...
