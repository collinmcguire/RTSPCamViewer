...
class QQuickItem(QtCore.QObject, QtQml.QQmlParserStatus):
    ...
    class Flags(enum.Flag):
        ItemClipsChildrenToShape = ... # type: QQuickItem.Flags
        ItemAcceptsInputMethod = ... # type: QQuickItem.Flags
        ItemIsFocusScope = ... # type: QQuickItem.Flags
        ItemHasContents = ... # type: QQuickItem.Flags
        ItemAcceptsDrops = ... # type: QQuickItem.Flags
    ...
    def updateInputMethod(self, queries: QtCore.Qt.InputMethodQueries = ...) -> None: ...
    ...
    def inputMethodQuery(self, query: QtCore.Qt.InputMethodQueries) -> typing.Any: ...
    ...
    def setFlags(self, flags: 'QQuickItem.Flags') -> None: ...
    def setFlag(self, flag: 'QQuickItem.Flags', enabled: bool = ...) -> None: ...
...
class QQuickImageProvider(QtQml.QQmlImageProviderBase):
    ...
    def __init__(self, type: QtQml.QQmlImageProviderBase.ImageType, flags: QtQml.QQmlImageProviderBase.Flags = ...) -> None: ...
...
class QQuickPaintedItem(QQuickItem):
    ...
    class PerformanceHints(enum.Flag):
        FastFBOResizing = ... # type: QQuickPaintedItem.PerformanceHints
    ...
    def setPerformanceHints(self, hints: 'QQuickPaintedItem.PerformanceHints') -> None: ...
    def setPerformanceHint(self, hint: 'QQuickPaintedItem.PerformanceHints', enabled: bool = ...) -> None: ...
...
class QQuickWindow(QtGui.QWindow):
    ...
    class CreateTextureOptions(enum.Flag):
        TextureHasAlphaChannel = ... # type: QQuickWindow.CreateTextureOptions
        TextureHasMipmaps = ... # type: QQuickWindow.CreateTextureOptions
        TextureOwnsGLTexture = ... # type: QQuickWindow.CreateTextureOptions
        TextureCanUseAtlas = ... # type: QQuickWindow.CreateTextureOptions
        TextureIsOpaque = ... # type: QQuickWindow.CreateTextureOptions
    ...
    @typing.overload
    def createTextureFromImage(self, image: QtGui.QImage, options: 'QQuickWindow.CreateTextureOptions') -> 'QSGTexture': ...
...
class QSGMaterial(PyQt6.sip.wrapper):
    ...
    class Flags(enum.Flag):
        Blending = ... # type: QSGMaterial.Flags
        RequiresDeterminant = ... # type: QSGMaterial.Flags
        RequiresFullMatrixExceptTranslate = ... # type: QSGMaterial.Flags
        RequiresFullMatrix = ... # type: QSGMaterial.Flags
        CustomCompileStep = ... # type: QSGMaterial.Flags

    def __init__(self) -> None: ...

    def setFlag(self, flags: 'QSGMaterial.Flags', enabled: bool = ...) -> None: ...
...
class QSGNode(PyQt6.sip.wrapper):
    ...
    class DirtyState(enum.Flag):
        DirtyMatrix = ... # type: QSGNode.DirtyState
        DirtyNodeAdded = ... # type: QSGNode.DirtyState
        DirtyNodeRemoved = ... # type: QSGNode.DirtyState
        DirtyGeometry = ... # type: QSGNode.DirtyState
        DirtyMaterial = ... # type: QSGNode.DirtyState
        DirtyOpacity = ... # type: QSGNode.DirtyState

    class Flags(enum.Flag):
        OwnedByParent = ... # type: QSGNode.Flags
        UsePreprocess = ... # type: QSGNode.Flags
        OwnsGeometry = ... # type: QSGNode.Flags
        OwnsMaterial = ... # type: QSGNode.Flags
        OwnsOpaqueMaterial = ... # type: QSGNode.Flags
    ...
    def setFlags(self, a0: 'QSGNode.Flags', enabled: bool = ...) -> None: ...
    def setFlag(self, a0: 'QSGNode.Flags', enabled: bool = ...) -> None: ...
    def flags(self) -> 'QSGNode.Flags': ...
    def isSubtreeBlocked(self) -> bool: ...
    def markDirty(self, bits: 'QSGNode.DirtyState') -> None: ...
...
class QSGImageNode(QSGGeometryNode):
    ...
    class TextureCoordinatesTransformMode(enum.Flag):
        NoTransform = ... # type: QSGImageNode.TextureCoordinatesTransformMode
        MirrorHorizontally = ... # type: QSGImageNode.TextureCoordinatesTransformMode
        MirrorVertically = ... # type: QSGImageNode.TextureCoordinatesTransformMode

    def anisotropyLevel(self) -> 'QSGTexture.AnisotropyLevel': ...
    def setAnisotropyLevel(self, level: 'QSGTexture.AnisotropyLevel') -> None: ...
    @staticmethod
    def rebuildGeometry(g: QSGGeometry, texture: 'QSGTexture', rect: QtCore.QRectF, sourceRect: QtCore.QRectF, texCoordMode: 'QSGImageNode.TextureCoordinatesTransformMode') -> None: ...
    ...
    def setTextureCoordinatesTransform(self, mode: 'QSGImageNode.TextureCoordinatesTransformMode') -> None: ...
...
class QSGMaterialShader(PyQt6.sip.simplewrapper):
    ...
    class Flags(enum.Flag):
        UpdatesGraphicsPipelineState = ... # type: QSGMaterialShader.Flags

    class RenderState(PyQt6.sip.simplewrapper):

        class DirtyStates(enum.Flag):
            DirtyMatrix = ... # type: QSGMaterialShader.RenderState.DirtyStates
            DirtyOpacity = ... # type: QSGMaterialShader.RenderState.DirtyStates
            DirtyCachedMaterialData = ... # type: QSGMaterialShader.RenderState.DirtyStates
            DirtyAll = ... # type: QSGMaterialShader.RenderState.DirtyStates
    ...
    class GraphicsPipelineState(PyQt6.sip.simplewrapper):
        ...
        class ColorMask(enum.Flag):
            R = ... # type: QSGMaterialShader.GraphicsPipelineState.ColorMask
            G = ... # type: QSGMaterialShader.GraphicsPipelineState.ColorMask
            B = ... # type: QSGMaterialShader.GraphicsPipelineState.ColorMask
            A = ... # type: QSGMaterialShader.GraphicsPipelineState.ColorMask
    ...
    def setFlags(self, flags: 'QSGMaterialShader.Flags') -> None: ...
    def setFlag(self, flags: 'QSGMaterialShader.Flags', on: bool = ...) -> None: ...
    def flags(self) -> 'QSGMaterialShader.Flags': ...
...
class QSGRendererInterface(PyQt6.sip.simplewrapper):
    ...
    class ShaderSourceTypes(enum.Flag):
        ShaderSourceString = ... # type: QSGRendererInterface.ShaderSourceTypes
        ShaderSourceFile = ... # type: QSGRendererInterface.ShaderSourceTypes
        ShaderByteCode = ... # type: QSGRendererInterface.ShaderSourceTypes

    class ShaderCompilationTypes(enum.Flag):
        RuntimeCompilation = ... # type: QSGRendererInterface.ShaderCompilationTypes
        OfflineCompilation = ... # type: QSGRendererInterface.ShaderCompilationTypes
...
class QSGRenderNode(QSGNode):
    ...
    class RenderingFlags(enum.Flag):
        BoundedRectRendering = ... # type: QSGRenderNode.RenderingFlags
        DepthAwareRendering = ... # type: QSGRenderNode.RenderingFlags
        OpaqueRendering = ... # type: QSGRenderNode.RenderingFlags

    class StateFlags(enum.Flag):
        DepthState = ... # type: QSGRenderNode.StateFlags
        StencilState = ... # type: QSGRenderNode.StateFlags
        ScissorState = ... # type: QSGRenderNode.StateFlags
        ColorState = ... # type: QSGRenderNode.StateFlags
        BlendState = ... # type: QSGRenderNode.StateFlags
        CullState = ... # type: QSGRenderNode.StateFlags
        ViewportState = ... # type: QSGRenderNode.StateFlags
        RenderTargetState = ... # type: QSGRenderNode.StateFlags
...
class QSGSimpleTextureNode(QSGGeometryNode):
    ...
    class TextureCoordinatesTransformMode(enum.Flag):
        NoTransform = ... # type: QSGSimpleTextureNode.TextureCoordinatesTransformMode
        MirrorHorizontally = ... # type: QSGSimpleTextureNode.TextureCoordinatesTransformMode
        MirrorVertically = ... # type: QSGSimpleTextureNode.TextureCoordinatesTransformMode
...
class QNativeInterface(PyQt6.sip.simplewrapper):
    ...
    class QSGOpenGLTexture(PyQt6.sip.simplewrapper):
        ...
        @staticmethod
        def fromNative(textureId: int, window: QQuickWindow, size: QtCore.QSize, options: QQuickWindow.CreateTextureOptions = ...) -> QSGTexture: ...
