...
class QDBusConnection(PyQt6.sip.simplewrapper):
    ...
    class ConnectionCapabilities(enum.Flag):
        UnixFileDescriptorPassing = ... # type: QDBusConnection.ConnectionCapabilities
    ...
    class RegisterOptions(enum.Flag):
        ExportAdaptors = ... # type: QDBusConnection.RegisterOptions
        ExportScriptableSlots = ... # type: QDBusConnection.RegisterOptions
        ExportScriptableSignals = ... # type: QDBusConnection.RegisterOptions
        ExportScriptableProperties = ... # type: QDBusConnection.RegisterOptions
        ExportScriptableInvokables = ... # type: QDBusConnection.RegisterOptions
        ExportScriptableContents = ... # type: QDBusConnection.RegisterOptions
        ExportNonScriptableSlots = ... # type: QDBusConnection.RegisterOptions
        ExportNonScriptableSignals = ... # type: QDBusConnection.RegisterOptions
        ExportNonScriptableProperties = ... # type: QDBusConnection.RegisterOptions
        ExportNonScriptableInvokables = ... # type: QDBusConnection.RegisterOptions
        ExportNonScriptableContents = ... # type: QDBusConnection.RegisterOptions
        ExportAllSlots = ... # type: QDBusConnection.RegisterOptions
        ExportAllSignals = ... # type: QDBusConnection.RegisterOptions
        ExportAllProperties = ... # type: QDBusConnection.RegisterOptions
        ExportAllInvokables = ... # type: QDBusConnection.RegisterOptions
        ExportAllContents = ... # type: QDBusConnection.RegisterOptions
        ExportAllSignal = ... # type: QDBusConnection.RegisterOptions
        ExportChildObjects = ... # type: QDBusConnection.RegisterOptions
    ...
    @typing.overload
    def registerObject(self, path: str, object: QtCore.QObject, options: 'QDBusConnection.RegisterOptions' = ...) -> bool: ...
    @typing.overload
    def registerObject(self, path: str, interface: str, object: QtCore.QObject, options: 'QDBusConnection.RegisterOptions' = ...) -> bool: ...
    @typing.overload
...
class QDBusServiceWatcher(QtCore.QObject):
    ...
    class WatchMode(enum.Flag):
        WatchForRegistration = ... # type: QDBusServiceWatcher.WatchMode
        WatchForUnregistration = ... # type: QDBusServiceWatcher.WatchMode
        WatchForOwnerChange = ... # type: QDBusServiceWatcher.WatchMode

    @typing.overload
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    @typing.overload
    def __init__(self, service: str, connection: QDBusConnection, watchMode: 'QDBusServiceWatcher.WatchMode' = ..., parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
