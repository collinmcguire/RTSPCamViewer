...
class QJSEngine(QtCore.QObject):
    ...
    class Extensions(enum.Flag):
        TranslationExtension = ... # type: QJSEngine.Extensions
        ConsoleExtension = ... # type: QJSEngine.Extensions
        GarbageCollectionExtension = ... # type: QJSEngine.Extensions
        AllExtensions = ... # type: QJSEngine.Extensions
    ...
    def installExtensions(self, extensions: 'QJSEngine.Extensions', object: typing.Union['QJSValue', 'QJSValue.SpecialValue', bool, int, float, str] = ...) -> None: ...
...
class QQmlImageProviderBase(QtCore.QObject):
    ...
    class Flags(enum.Flag):
        ForceAsynchronousImageLoading = ... # type: QQmlImageProviderBase.Flags
