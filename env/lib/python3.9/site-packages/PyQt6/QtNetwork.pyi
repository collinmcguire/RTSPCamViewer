...
class QAbstractSocket(QtCore.QIODevice):
    ...
    class PauseModes(enum.Flag):
        PauseNever = ... # type: QAbstractSocket.PauseModes
        PauseOnSslErrors = ... # type: QAbstractSocket.PauseModes

    class BindMode(enum.Flag):
        DefaultForPlatform = ... # type: QAbstractSocket.BindMode
        ShareAddress = ... # type: QAbstractSocket.BindMode
        DontShareAddress = ... # type: QAbstractSocket.BindMode
        ReuseAddressHint = ... # type: QAbstractSocket.BindMode
    ...
    @typing.overload
    def bind(self, address: typing.Union['QHostAddress', 'QHostAddress.SpecialAddress'], port: int = ..., mode: 'QAbstractSocket.BindMode' = ...) -> bool: ...
    @typing.overload
    def bind(self, port: int = ..., mode: 'QAbstractSocket.BindMode' = ...) -> bool: ...
    def setPauseMode(self, pauseMode: 'QAbstractSocket.PauseModes') -> None: ...
    ...
    def setSocketDescriptor(self, socketDescriptor: PyQt6.sip.voidptr, state: 'QAbstractSocket.SocketState' = ..., mode: QtCore.QIODeviceBase.OpenMode = ...) -> bool: ...
    def abort(self) -> None: ...
    ...
    @typing.overload
    def connectToHost(self, hostName: str, port: int, mode: QtCore.QIODeviceBase.OpenMode = ..., protocol: 'QAbstractSocket.NetworkLayerProtocol' = ...) -> None: ...
    @typing.overload
    def connectToHost(self, address: typing.Union['QHostAddress', 'QHostAddress.SpecialAddress'], port: int, mode: QtCore.QIODeviceBase.OpenMode = ...) -> None: ...
...
class QHostAddress(PyQt6.sip.simplewrapper):
    ...
    class ConversionMode(enum.Flag):
        ConvertV4MappedToIPv4 = ... # type: QHostAddress.ConversionMode
        ConvertV4CompatToIPv4 = ... # type: QHostAddress.ConversionMode
        ConvertUnspecifiedAddress = ... # type: QHostAddress.ConversionMode
        ConvertLocalHost = ... # type: QHostAddress.ConversionMode
        TolerantConversion = ... # type: QHostAddress.ConversionMode
        StrictConversion = ... # type: QHostAddress.ConversionMode
    ...
    def isEqual(self, address: typing.Union['QHostAddress', 'QHostAddress.SpecialAddress'], mode: 'QHostAddress.ConversionMode' = ...) -> bool: ...
...
class QHstsPolicy(PyQt6.sip.simplewrapper):
    ...
    class PolicyFlags(enum.Flag):
        IncludeSubDomains = ... # type: QHstsPolicy.PolicyFlags

    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, expiry: typing.Union[QtCore.QDateTime, datetime.datetime], flags: 'QHstsPolicy.PolicyFlags', host: str, mode: QtCore.QUrl.ParsingMode = ...) -> None: ...
    @typing.overload
    ...
    def host(self, options: QtCore.QUrl.ComponentFormattingOptions = ...) -> str: ...
...
class QLocalServer(QtCore.QObject):
    ...
    class SocketOptions(enum.Flag):
        UserAccessOption = ... # type: QLocalServer.SocketOptions
        GroupAccessOption = ... # type: QLocalServer.SocketOptions
        OtherAccessOption = ... # type: QLocalServer.SocketOptions
        WorldAccessOption = ... # type: QLocalServer.SocketOptions

    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...

    def socketDescriptor(self) -> PyQt6.sip.voidptr: ...
    def socketOptions(self) -> 'QLocalServer.SocketOptions': ...
    def setSocketOptions(self, options: 'QLocalServer.SocketOptions') -> None: ...
...
class QLocalSocket(QtCore.QIODevice):
    ...
    def socketDescriptor(self) -> PyQt6.sip.voidptr: ...
    def setSocketDescriptor(self, socketDescriptor: PyQt6.sip.voidptr, state: 'QLocalSocket.LocalSocketState' = ..., mode: QtCore.QIODeviceBase.OpenMode = ...) -> bool: ...
    def setReadBufferSize(self, size: int) -> None: ...
    def readBufferSize(self) -> int: ...
    def isValid(self) -> bool: ...
    def flush(self) -> bool: ...
    ...
    def serverName(self) -> str: ...
    def open(self, mode: QtCore.QIODeviceBase.OpenMode = ...) -> bool: ...
    def disconnectFromServer(self) -> None: ...
    @typing.overload
    def connectToServer(self, name: str, mode: QtCore.QIODeviceBase.OpenMode = ...) -> None: ...
    @typing.overload
    def connectToServer(self, mode: QtCore.QIODeviceBase.OpenMode = ...) -> None: ...
...
class QNetworkInterface(PyQt6.sip.simplewrapper):
    ...
    class InterfaceFlags(enum.Flag):
        IsUp = ... # type: QNetworkInterface.InterfaceFlags
        IsRunning = ... # type: QNetworkInterface.InterfaceFlags
        CanBroadcast = ... # type: QNetworkInterface.InterfaceFlags
        IsLoopBack = ... # type: QNetworkInterface.InterfaceFlags
        IsPointToPoint = ... # type: QNetworkInterface.InterfaceFlags
        CanMulticast = ... # type: QNetworkInterface.InterfaceFlags
...
class QNetworkProxy(PyQt6.sip.simplewrapper):
    ...
    class Capabilities(enum.Flag):
        TunnelingCapability = ... # type: QNetworkProxy.Capabilities
        ListeningCapability = ... # type: QNetworkProxy.Capabilities
        UdpTunnelingCapability = ... # type: QNetworkProxy.Capabilities
        CachingCapability = ... # type: QNetworkProxy.Capabilities
        HostNameLookupCapability = ... # type: QNetworkProxy.Capabilities
        SctpTunnelingCapability = ... # type: QNetworkProxy.Capabilities
        SctpListeningCapability = ... # type: QNetworkProxy.Capabilities
...
class QSsl(PyQt6.sip.simplewrapper):
    ...
    class SslOptions(enum.Flag):
        SslOptionDisableEmptyFragments = ... # type: QSsl.SslOptions
        SslOptionDisableSessionTickets = ... # type: QSsl.SslOptions
        SslOptionDisableCompression = ... # type: QSsl.SslOptions
        SslOptionDisableServerNameIndication = ... # type: QSsl.SslOptions
        SslOptionDisableLegacyRenegotiation = ... # type: QSsl.SslOptions
        SslOptionDisableSessionSharing = ... # type: QSsl.SslOptions
        SslOptionDisableSessionPersistence = ... # type: QSsl.SslOptions
        SslOptionDisableServerCipherPreference = ... # type: QSsl.SslOptions
...
class QSslConfiguration(PyQt6.sip.simplewrapper):
    ...
    def testSslOption(self, option: QSsl.SslOptions) -> bool: ...
    def setSslOption(self, option: QSsl.SslOptions, on: bool) -> None: ...
    @staticmethod
...
class QSslSocket(QTcpSocket):
    ...
    def setSocketDescriptor(self, socketDescriptor: PyQt6.sip.voidptr, state: QAbstractSocket.SocketState = ..., mode: QtCore.QIODeviceBase.OpenMode = ...) -> bool: ...
    @typing.overload
    def connectToHostEncrypted(self, hostName: str, port: int, mode: QtCore.QIODeviceBase.OpenMode = ..., protocol: QAbstractSocket.NetworkLayerProtocol = ...) -> None: ...
    @typing.overload
    def connectToHostEncrypted(self, hostName: str, port: int, sslPeerName: str, mode: QtCore.QIODeviceBase.OpenMode = ..., protocol: QAbstractSocket.NetworkLayerProtocol = ...) -> None: ...
