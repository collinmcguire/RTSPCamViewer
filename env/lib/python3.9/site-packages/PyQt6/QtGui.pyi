...
class QAbstractFileIconProvider(PyQt6.sip.simplewrapper):
    ...
    class Options(enum.Flag):
        DontUseCustomDirectoryIcons = ... # type: QAbstractFileIconProvider.Options
    ...
    def options(self) -> 'QAbstractFileIconProvider.Options': ...
    def setOptions(self, a0: 'QAbstractFileIconProvider.Options') -> None: ...
...
class QPixmap(QPaintDevice):
    ...
    @typing.overload
    def __init__(self, fileName: str, format: typing.Optional[str] = ..., flags: QtCore.Qt.ImageConversionFlags = ...) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def loadFromData(self, buf: bytes, format: typing.Optional[str] = ..., flags: QtCore.Qt.ImageConversionFlags = ...) -> bool: ...
    @typing.overload
    def loadFromData(self, buf: QtCore.QByteArray, format: typing.Optional[str] = ..., flags: QtCore.Qt.ImageConversionFlags = ...) -> bool: ...
    def load(self, fileName: str, format: typing.Optional[str] = ..., flags: QtCore.Qt.ImageConversionFlags = ...) -> bool: ...
    def convertFromImage(self, img: 'QImage', flags: QtCore.Qt.ImageConversionFlags = ...) -> bool: ...
    @staticmethod
    def fromImageReader(imageReader: 'QImageReader', flags: QtCore.Qt.ImageConversionFlags = ...) -> 'QPixmap': ...
    @staticmethod
    def fromImage(image: 'QImage', flags: QtCore.Qt.ImageConversionFlags = ...) -> 'QPixmap': ...
...
class QBitmap(QPixmap):
    ...
    @staticmethod
    def fromImage(image: 'QImage', flags: QtCore.Qt.ImageConversionFlags = ...) -> 'QBitmap': ...
    def clear(self) -> None: ...
...
class QDrag(QtCore.QObject):
    ...
    def defaultAction(self) -> QtCore.Qt.DropActions: ...
    def supportedActions(self) -> QtCore.Qt.DropActions: ...
    def dragCursor(self, action: QtCore.Qt.DropActions) -> QPixmap: ...
    def targetChanged(self, newTarget: QtCore.QObject) -> None: ...
    def actionChanged(self, action: QtCore.Qt.DropActions) -> None: ...
    def setDragCursor(self, cursor: QPixmap, action: QtCore.Qt.DropActions) -> None: ...
    ...
    @typing.overload
    def exec(self, supportedActions: QtCore.Qt.DropActions = ...) -> QtCore.Qt.DropActions: ...
    @typing.overload
    def exec(self, supportedActions: QtCore.Qt.DropActions, defaultDropAction: QtCore.Qt.DropActions) -> QtCore.Qt.DropActions: ...


class QInputEvent(QtCore.QEvent):

    def clone(self) -> 'QInputEvent': ...
    def deviceType(self) -> 'QInputDevice.DeviceTypes': ...
...
class QKeyEvent(QInputEvent):
    ...
    @typing.overload
    def __init__(self, type: QtCore.QEvent.Type, key: int, modifiers: QtCore.Qt.KeyboardModifiers, nativeScanCode: int, nativeVirtualKey: int, nativeModifiers: int, text: str = ..., autorep: bool = ..., count: int = ..., device: typing.Optional['QInputDevice'] = ...) -> None: ...
    @typing.overload
    def __init__(self, type: QtCore.QEvent.Type, key: int, modifiers: QtCore.Qt.KeyboardModifiers, text: str = ..., autorep: bool = ..., count: int = ...) -> None: ...
...
class QContextMenuEvent(QInputEvent):
    ...
    @typing.overload
    def __init__(self, reason: 'QContextMenuEvent.Reason', pos: QtCore.QPoint, globalPos: QtCore.QPoint, modifiers: QtCore.Qt.KeyboardModifiers = ...) -> None: ...
    @typing.overload
...
class QInputMethodQueryEvent(QtCore.QEvent):
    ...
    def __init__(self, queries: QtCore.Qt.InputMethodQueries) -> None: ...

    def clone(self) -> 'QInputMethodQueryEvent': ...
    def value(self, query: QtCore.Qt.InputMethodQueries) -> typing.Any: ...
    def setValue(self, query: QtCore.Qt.InputMethodQueries, value: typing.Any) -> None: ...
    def queries(self) -> QtCore.Qt.InputMethodQueries: ...


class QDropEvent(QtCore.QEvent):

    def __init__(self, pos: QtCore.QPointF, actions: QtCore.Qt.DropActions, data: QtCore.QMimeData, buttons: QtCore.Qt.MouseButtons, modifiers: QtCore.Qt.KeyboardModifiers, type: QtCore.QEvent.Type = ...) -> None: ...
...
class QDragMoveEvent(QDropEvent):
    ...
    def __init__(self, pos: QtCore.QPoint, actions: QtCore.Qt.DropActions, data: QtCore.QMimeData, buttons: QtCore.Qt.MouseButtons, modifiers: QtCore.Qt.KeyboardModifiers, type: QtCore.QEvent.Type = ...) -> None: ...
...
class QDragEnterEvent(QDragMoveEvent):
    ...
    def __init__(self, pos: QtCore.QPoint, actions: QtCore.Qt.DropActions, data: QtCore.QMimeData, buttons: QtCore.Qt.MouseButtons, modifiers: QtCore.Qt.KeyboardModifiers) -> None: ...
...
class QFileOpenEvent(QtCore.QEvent):
    ...
    def openFile(self, file: QtCore.QFile, flags: QtCore.QIODeviceBase.OpenMode) -> bool: ...
...
class QPointerEvent(QInputEvent):
    ...
    def pointerType(self) -> 'QPointingDevice.PointerTypes': ...
...
class QMouseEvent(QSinglePointEvent):
    ...
    @typing.overload
    def __init__(self, type: QtCore.QEvent.Type, localPos: QtCore.QPointF, button: QtCore.Qt.MouseButtons, buttons: QtCore.Qt.MouseButtons, modifiers: QtCore.Qt.KeyboardModifiers, device: typing.Optional['QPointingDevice'] = ...) -> None: ...
    @typing.overload
    def __init__(self, type: QtCore.QEvent.Type, localPos: QtCore.QPointF, globalPos: QtCore.QPointF, button: QtCore.Qt.MouseButtons, buttons: QtCore.Qt.MouseButtons, modifiers: QtCore.Qt.KeyboardModifiers, device: typing.Optional['QPointingDevice'] = ...) -> None: ...
    @typing.overload
    def __init__(self, type: QtCore.QEvent.Type, localPos: QtCore.QPointF, scenePos: QtCore.QPointF, globalPos: QtCore.QPointF, button: QtCore.Qt.MouseButtons, buttons: QtCore.Qt.MouseButtons, modifiers: QtCore.Qt.KeyboardModifiers, device: typing.Optional['QPointingDevice'] = ...) -> None: ...
...
class QHoverEvent(QSinglePointEvent):
    ...
    def __init__(self, type: QtCore.QEvent.Type, pos: QtCore.QPointF, oldPos: QtCore.QPointF, modifiers: QtCore.Qt.KeyboardModifiers = ..., device: typing.Optional['QPointingDevice'] = ...) -> None: ...
...
class QWheelEvent(QSinglePointEvent):
    ...
    def __init__(self, pos: QtCore.QPointF, globalPos: QtCore.QPointF, pixelDelta: QtCore.QPoint, angleDelta: QtCore.QPoint, buttons: QtCore.Qt.MouseButtons, modifiers: QtCore.Qt.KeyboardModifiers, phase: QtCore.Qt.ScrollPhase, inverted: bool, source: QtCore.Qt.MouseEventSource = ..., device: typing.Optional['QPointingDevice'] = ...) -> None: ...
...
class QTabletEvent(QSinglePointEvent):
    ...
    def __init__(self, t: QtCore.QEvent.Type, device: 'QPointingDevice', pos: QtCore.QPointF, globalPos: QtCore.QPointF, pressure: float, xTilt: float, yTilt: float, tangentialPressure: float, rotation: float, z: float, keyState: QtCore.Qt.KeyboardModifiers, button: QtCore.Qt.MouseButtons, buttons: QtCore.Qt.MouseButtons) -> None: ...
...
class QTouchEvent(QPointerEvent):
    ...
    def __init__(self, eventType: QtCore.QEvent.Type, device: typing.Optional['QPointingDevice'] = ..., modifiers: QtCore.Qt.KeyboardModifiers = ..., touchPoints: typing.Iterable['QEventPoint'] = ...) -> None: ...

    def clone(self) -> 'QTouchEvent': ...
    def isEndEvent(self) -> bool: ...
    def isUpdateEvent(self) -> bool: ...
    def isBeginEvent(self) -> bool: ...
    def touchPointStates(self) -> 'QEventPoint.States': ...
    def target(self) -> QtCore.QObject: ...


class QEventPoint(PyQt6.sip.simplewrapper):

    class States(enum.Flag):
        Unknown = ... # type: QEventPoint.States
        Stationary = ... # type: QEventPoint.States
        Pressed = ... # type: QEventPoint.States
        Updated = ... # type: QEventPoint.States
        Released = ... # type: QEventPoint.States

    @typing.overload
    def __init__(self, pointId: int, state: 'QEventPoint.States', scenePosition: QtCore.QPointF, globalPosition: QtCore.QPointF) -> None: ...
    @typing.overload
    ...
    def state(self) -> 'QEventPoint.States': ...
...
class QFileSystemModel(QtCore.QAbstractItemModel):
    ...
    class Options(enum.Flag):
        DontWatchForChanges = ... # type: QFileSystemModel.Options
        DontResolveSymlinks = ... # type: QFileSystemModel.Options
        DontUseCustomDirectoryIcons = ... # type: QFileSystemModel.Options
    ...
    def testOption(self, option: 'QFileSystemModel.Options') -> bool: ...
    def setOption(self, option: 'QFileSystemModel.Options', on: bool = ...) -> None: ...
    ...
    def dropMimeData(self, data: QtCore.QMimeData, action: QtCore.Qt.DropActions, row: int, column: int, parent: QtCore.QModelIndex) -> bool: ...
...
class QGlyphRun(PyQt6.sip.simplewrapper):
    ...
    class GlyphRunFlags(enum.Flag):
        Overline = ... # type: QGlyphRun.GlyphRunFlags
        Underline = ... # type: QGlyphRun.GlyphRunFlags
        StrikeOut = ... # type: QGlyphRun.GlyphRunFlags
        RightToLeft = ... # type: QGlyphRun.GlyphRunFlags
        SplitLigature = ... # type: QGlyphRun.GlyphRunFlags
    ...
    def setFlags(self, flags: 'QGlyphRun.GlyphRunFlags') -> None: ...
    def setFlag(self, flag: 'QGlyphRun.GlyphRunFlags', enabled: bool = ...) -> None: ...
...
class QGuiApplication(QtCore.QCoreApplication):
    ...
    def sync() -> None: ...
    @staticmethod
    def applicationState() -> QtCore.Qt.ApplicationStates: ...
    ...
    def applicationStateChanged(self, state: QtCore.Qt.ApplicationStates) -> None: ...
...
class QIcon(PyQt6.sip.wrapper):
    ...
    def isNull(self) -> bool: ...
    @typing.overload
    def paint(self, painter: 'QPainter', rect: QtCore.QRect, alignment: QtCore.Qt.Alignment = ..., mode: 'QIcon.Mode' = ..., state: 'QIcon.State' = ...) -> None: ...
    @typing.overload
    def paint(self, painter: 'QPainter', x: int, y: int, w: int, h: int, alignment: QtCore.Qt.Alignment = ..., mode: 'QIcon.Mode' = ..., state: 'QIcon.State' = ...) -> None: ...
...
class QImage(QPaintDevice):
    ...
    def convertTo(self, f: 'QImage.Format', flags: QtCore.Qt.ImageConversionFlags = ...) -> None: ...
    def convertedTo(self, f: 'QImage.Format', flags: QtCore.Qt.ImageConversionFlags = ...) -> 'QImage': ...
    ...
    def createAlphaMask(self, flags: QtCore.Qt.ImageConversionFlags = ...) -> 'QImage': ...
    ...
    def width(self) -> int: ...
    @typing.overload
    def convertToFormat(self, f: 'QImage.Format', flags: QtCore.Qt.ImageConversionFlags = ...) -> 'QImage': ...
    @typing.overload
    def convertToFormat(self, f: 'QImage.Format', colorTable: typing.Iterable[int], flags: QtCore.Qt.ImageConversionFlags = ...) -> 'QImage': ...
...
class QImageIOHandler(PyQt6.sip.simplewrapper):
    ...
    class Transformations(enum.Flag):
        TransformationNone = ... # type: QImageIOHandler.Transformations
        TransformationMirror = ... # type: QImageIOHandler.Transformations
        TransformationFlip = ... # type: QImageIOHandler.Transformations
        TransformationRotate180 = ... # type: QImageIOHandler.Transformations
        TransformationRotate90 = ... # type: QImageIOHandler.Transformations
        TransformationMirrorAndRotate90 = ... # type: QImageIOHandler.Transformations
        TransformationFlipAndRotate90 = ... # type: QImageIOHandler.Transformations
        TransformationRotate270 = ... # type: QImageIOHandler.Transformations
...
class QImageWriter(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def imageFormatsForMimeType(mimeType: QtCore.QByteArray) -> typing.List[QtCore.QByteArray]: ...
    def setTransformation(self, orientation: QImageIOHandler.Transformations) -> None: ...
    def transformation(self) -> QImageIOHandler.Transformations: ...
...
class QInputDevice(QtCore.QObject):
    ...
    class Capabilities(enum.Flag):
        None_ = ... # type: QInputDevice.Capabilities
        Position = ... # type: QInputDevice.Capabilities
        Area = ... # type: QInputDevice.Capabilities
        Pressure = ... # type: QInputDevice.Capabilities
        Velocity = ... # type: QInputDevice.Capabilities
        NormalizedPosition = ... # type: QInputDevice.Capabilities
        MouseEmulation = ... # type: QInputDevice.Capabilities
        Scroll = ... # type: QInputDevice.Capabilities
        Hover = ... # type: QInputDevice.Capabilities
        Rotation = ... # type: QInputDevice.Capabilities
        XTilt = ... # type: QInputDevice.Capabilities
        YTilt = ... # type: QInputDevice.Capabilities
        TangentialPressure = ... # type: QInputDevice.Capabilities
        ZPosition = ... # type: QInputDevice.Capabilities
        All = ... # type: QInputDevice.Capabilities

    class DeviceTypes(enum.Flag):
        Unknown = ... # type: QInputDevice.DeviceTypes
        Mouse = ... # type: QInputDevice.DeviceTypes
        TouchScreen = ... # type: QInputDevice.DeviceTypes
        TouchPad = ... # type: QInputDevice.DeviceTypes
        Puck = ... # type: QInputDevice.DeviceTypes
        Stylus = ... # type: QInputDevice.DeviceTypes
        Airbrush = ... # type: QInputDevice.DeviceTypes
        Keyboard = ... # type: QInputDevice.DeviceTypes
        AllDevices = ... # type: QInputDevice.DeviceTypes

    @typing.overload
    def __init__(self, name: str, systemId: int, type: 'QInputDevice.DeviceTypes', seatName: str = ..., parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    ...
    def hasCapability(self, cap: 'QInputDevice.Capabilities') -> bool: ...
    def capabilities(self) -> 'QInputDevice.Capabilities': ...
    def type(self) -> 'QInputDevice.DeviceTypes': ...
    def name(self) -> str: ...
...
class QInputMethod(QtCore.QObject):
    ...
    def reset(self) -> None: ...
    def update(self, queries: QtCore.Qt.InputMethodQueries) -> None: ...
    def hide(self) -> None: ...
    def show(self) -> None: ...
    @staticmethod
    def queryFocusObject(query: QtCore.Qt.InputMethodQueries, argument: typing.Any) -> typing.Any: ...
...
class QWindow(QtCore.QObject, QSurface):
    ...
    def startSystemResize(self, edges: QtCore.Qt.Edges) -> bool: ...
    def setWindowStates(self, states: QtCore.Qt.WindowStates) -> None: ...
    def windowStates(self) -> QtCore.Qt.WindowStates: ...
    def setFlag(self, a0: QtCore.Qt.WindowFlags, on: bool = ...) -> None: ...
    ...
    def contentOrientationChanged(self, orientation: QtCore.Qt.ScreenOrientations) -> None: ...
    ...
    def windowStateChanged(self, windowState: QtCore.Qt.WindowStates) -> None: ...
    ...
    def devicePixelRatio(self) -> float: ...
    def contentOrientation(self) -> QtCore.Qt.ScreenOrientations: ...
    def reportContentOrientationChange(self, orientation: QtCore.Qt.ScreenOrientations) -> None: ...
    def isActive(self) -> bool: ...
    def requestActivate(self) -> None: ...
    def setOpacity(self, level: float) -> None: ...
    def title(self) -> str: ...
    def type(self) -> QtCore.Qt.WindowFlags: ...
    def flags(self) -> QtCore.Qt.WindowFlags: ...
    def setFlags(self, flags: QtCore.Qt.WindowFlags) -> None: ...
    def requestedFormat(self) -> 'QSurfaceFormat': ...
    def format(self) -> 'QSurfaceFormat': ...
    def setFormat(self, format: 'QSurfaceFormat') -> None: ...
...
class QTextItem(PyQt6.sip.simplewrapper):
    ...
    class RenderFlags(enum.Flag):
        RightToLeft = ... # type: QTextItem.RenderFlags
        Overline = ... # type: QTextItem.RenderFlags
        Underline = ... # type: QTextItem.RenderFlags
        StrikeOut = ... # type: QTextItem.RenderFlags
...
class QPaintEngine(PyQt6.sip.simplewrapper):
    ...
    class DirtyFlags(enum.Flag):
        DirtyPen = ... # type: QPaintEngine.DirtyFlags
        DirtyBrush = ... # type: QPaintEngine.DirtyFlags
        DirtyBrushOrigin = ... # type: QPaintEngine.DirtyFlags
        DirtyFont = ... # type: QPaintEngine.DirtyFlags
        DirtyBackground = ... # type: QPaintEngine.DirtyFlags
        DirtyBackgroundMode = ... # type: QPaintEngine.DirtyFlags
        DirtyTransform = ... # type: QPaintEngine.DirtyFlags
        DirtyClipRegion = ... # type: QPaintEngine.DirtyFlags
        DirtyClipPath = ... # type: QPaintEngine.DirtyFlags
        DirtyHints = ... # type: QPaintEngine.DirtyFlags
        DirtyCompositionMode = ... # type: QPaintEngine.DirtyFlags
        DirtyClipEnabled = ... # type: QPaintEngine.DirtyFlags
        DirtyOpacity = ... # type: QPaintEngine.DirtyFlags
        AllDirty = ... # type: QPaintEngine.DirtyFlags

    class PaintEngineFeatures(enum.Flag):
        PrimitiveTransform = ... # type: QPaintEngine.PaintEngineFeatures
        PatternTransform = ... # type: QPaintEngine.PaintEngineFeatures
        PixmapTransform = ... # type: QPaintEngine.PaintEngineFeatures
        PatternBrush = ... # type: QPaintEngine.PaintEngineFeatures
        LinearGradientFill = ... # type: QPaintEngine.PaintEngineFeatures
        RadialGradientFill = ... # type: QPaintEngine.PaintEngineFeatures
        ConicalGradientFill = ... # type: QPaintEngine.PaintEngineFeatures
        AlphaBlend = ... # type: QPaintEngine.PaintEngineFeatures
        PorterDuff = ... # type: QPaintEngine.PaintEngineFeatures
        PainterPaths = ... # type: QPaintEngine.PaintEngineFeatures
        Antialiasing = ... # type: QPaintEngine.PaintEngineFeatures
        BrushStroke = ... # type: QPaintEngine.PaintEngineFeatures
        ConstantOpacity = ... # type: QPaintEngine.PaintEngineFeatures
        MaskedBrush = ... # type: QPaintEngine.PaintEngineFeatures
        PaintOutsidePaintEvent = ... # type: QPaintEngine.PaintEngineFeatures
        PerspectiveTransform = ... # type: QPaintEngine.PaintEngineFeatures
        BlendModes = ... # type: QPaintEngine.PaintEngineFeatures
        ObjectBoundingModeGradients = ... # type: QPaintEngine.PaintEngineFeatures
        RasterOpModes = ... # type: QPaintEngine.PaintEngineFeatures
        AllFeatures = ... # type: QPaintEngine.PaintEngineFeatures
    ...
    def paintDevice(self) -> QPaintDevice: ...
    def setPaintDevice(self, device: QPaintDevice) -> None: ...
    def drawImage(self, r: QtCore.QRectF, pm: QImage, sr: QtCore.QRectF, flags: QtCore.Qt.ImageConversionFlags = ...) -> None: ...
...
class QPainter(PyQt6.sip.simplewrapper):
    ...
    class PixmapFragmentHints(enum.Flag):
        OpaqueHint = ... # type: QPainter.PixmapFragmentHints
    ...
    class RenderHints(enum.Flag):
        Antialiasing = ... # type: QPainter.RenderHints
        TextAntialiasing = ... # type: QPainter.RenderHints
        SmoothPixmapTransform = ... # type: QPainter.RenderHints
        LosslessImageRendering = ... # type: QPainter.RenderHints
    ...
    def testRenderHint(self, hint: 'QPainter.RenderHints') -> bool: ...
    ...
    @typing.overload
    def drawImage(self, targetRect: QtCore.QRectF, image: QImage, sourceRect: QtCore.QRectF, flags: QtCore.Qt.ImageConversionFlags = ...) -> None: ...
    @typing.overload
    def drawImage(self, r: QtCore.QRect, image: QImage) -> None: ...
    @typing.overload
    def drawImage(self, targetRect: QtCore.QRect, image: QImage, sourceRect: QtCore.QRect, flags: QtCore.Qt.ImageConversionFlags = ...) -> None: ...
    @typing.overload
    def drawImage(self, p: QtCore.QPointF, image: QImage) -> None: ...
    @typing.overload
    def drawImage(self, p: QtCore.QPointF, image: QImage, sr: QtCore.QRectF, flags: QtCore.Qt.ImageConversionFlags = ...) -> None: ...
    @typing.overload
    def drawImage(self, p: QtCore.QPoint, image: QImage) -> None: ...
    @typing.overload
    def drawImage(self, p: QtCore.QPoint, image: QImage, sr: QtCore.QRect, flags: QtCore.Qt.ImageConversionFlags = ...) -> None: ...
    @typing.overload
    def drawImage(self, x: int, y: int, image: QImage, sx: int = ..., sy: int = ..., sw: int = ..., sh: int = ..., flags: QtCore.Qt.ImageConversionFlags = ...) -> None: ...
    @typing.overload
    ...
    def renderHints(self) -> 'QPainter.RenderHints': ...
    def setRenderHint(self, hint: 'QPainter.RenderHints', on: bool = ...) -> None: ...
    @typing.overload
...
class QPointingDevice(QInputDevice):
    ...
    class PointerTypes(enum.Flag):
        Unknown = ... # type: QPointingDevice.PointerTypes
        Generic = ... # type: QPointingDevice.PointerTypes
        Finger = ... # type: QPointingDevice.PointerTypes
        Pen = ... # type: QPointingDevice.PointerTypes
        Eraser = ... # type: QPointingDevice.PointerTypes
        Cursor = ... # type: QPointingDevice.PointerTypes
        AllPointerTypes = ... # type: QPointingDevice.PointerTypes

    @typing.overload
    def __init__(self, name: str, systemId: int, devType: QInputDevice.DeviceTypes, pType: 'QPointingDevice.PointerTypes', caps: QInputDevice.Capabilities, maxPoints: int, buttonCount: int, seatName: str = ..., uniqueId: QPointingDeviceUniqueId = ..., parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
...
class QRawFont(PyQt6.sip.simplewrapper):
    ...
    class LayoutFlags(enum.Flag):
        SeparateAdvances = ... # type: QRawFont.LayoutFlags
        KernedAdvances = ... # type: QRawFont.LayoutFlags
        UseDesignMetrics = ... # type: QRawFont.LayoutFlags
    ...
    @typing.overload
    def advancesForGlyphIndexes(self, glyphIndexes: typing.Iterable[int], layoutFlags: 'QRawFont.LayoutFlags') -> typing.List[QtCore.QPointF]: ...
    @typing.overload
...
class QScreen(QtCore.QObject):
    ...
    def orientationChanged(self, orientation: QtCore.Qt.ScreenOrientations) -> None: ...
    def primaryOrientationChanged(self, orientation: QtCore.Qt.ScreenOrientations) -> None: ...
    ...
    def isLandscape(self, orientation: QtCore.Qt.ScreenOrientations) -> bool: ...
    def isPortrait(self, orientation: QtCore.Qt.ScreenOrientations) -> bool: ...
    def mapBetween(self, a: QtCore.Qt.ScreenOrientations, b: QtCore.Qt.ScreenOrientations, rect: QtCore.QRect) -> QtCore.QRect: ...
    def transformBetween(self, a: QtCore.Qt.ScreenOrientations, b: QtCore.Qt.ScreenOrientations, target: QtCore.QRect) -> 'QTransform': ...
    def angleBetween(self, a: QtCore.Qt.ScreenOrientations, b: QtCore.Qt.ScreenOrientations) -> int: ...
    def orientation(self) -> QtCore.Qt.ScreenOrientations: ...
    def primaryOrientation(self) -> QtCore.Qt.ScreenOrientations: ...
    def nativeOrientation(self) -> QtCore.Qt.ScreenOrientations: ...
    def availableVirtualGeometry(self) -> QtCore.QRect: ...
...
class QStandardItemModel(QtCore.QAbstractItemModel):
    ...
    def findItems(self, text: str, flags: QtCore.Qt.MatchFlags = ..., column: int = ...) -> typing.List['QStandardItem']: ...
...
class QStandardItem(PyQt6.sip.wrapper):
    ...
    def setTextAlignment(self, atextAlignment: QtCore.Qt.Alignment) -> None: ...
...
class QSurfaceFormat(PyQt6.sip.simplewrapper):
    ...
    class FormatOptions(enum.Flag):
        StereoBuffers = ... # type: QSurfaceFormat.FormatOptions
        DebugContext = ... # type: QSurfaceFormat.FormatOptions
        DeprecatedFunctions = ... # type: QSurfaceFormat.FormatOptions
        ResetNotification = ... # type: QSurfaceFormat.FormatOptions

    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, options: 'QSurfaceFormat.FormatOptions') -> None: ...
    @typing.overload
    ...
    def testOption(self, option: 'QSurfaceFormat.FormatOptions') -> bool: ...
    def setOption(self, option: 'QSurfaceFormat.FormatOptions', on: bool = ...) -> None: ...
    def setOptions(self, options: 'QSurfaceFormat.FormatOptions') -> None: ...
...
class QTextDocument(QtCore.QObject):
    ...
    class MarkdownFeatures(enum.Flag):
        MarkdownNoHTML = ... # type: QTextDocument.MarkdownFeatures
        MarkdownDialectCommonMark = ... # type: QTextDocument.MarkdownFeatures
        MarkdownDialectGitHub = ... # type: QTextDocument.MarkdownFeatures
    ...
    class FindFlags(enum.Flag):
        FindBackward = ... # type: QTextDocument.FindFlags
        FindCaseSensitively = ... # type: QTextDocument.FindFlags
        FindWholeWords = ... # type: QTextDocument.FindFlags
    ...
    def setMarkdown(self, markdown: str, features: 'QTextDocument.MarkdownFeatures' = ...) -> None: ...
    def toMarkdown(self, features: 'QTextDocument.MarkdownFeatures' = ...) -> str: ...
...
class QTextFormat(PyQt6.sip.simplewrapper):
    ...
    class PageBreakFlags(enum.Flag):
        PageBreak_Auto = ... # type: QTextFormat.PageBreakFlags
        PageBreak_AlwaysBefore = ... # type: QTextFormat.PageBreakFlags
        PageBreak_AlwaysAfter = ... # type: QTextFormat.PageBreakFlags
...
class QTextBlockFormat(QTextFormat):
    ...
    def setAlignment(self, aalignment: QtCore.Qt.Alignment) -> None: ...
...
class QTextOption(PyQt6.sip.simplewrapper):
    ...
    class Flags(enum.Flag):
        IncludeTrailingSpaces = ... # type: QTextOption.Flags
        ShowTabsAndSpaces = ... # type: QTextOption.Flags
        ShowLineAndParagraphSeparators = ... # type: QTextOption.Flags
        AddSpaceForLineAndParagraphSeparators = ... # type: QTextOption.Flags
        SuppressColors = ... # type: QTextOption.Flags
        ShowDocumentTerminator = ... # type: QTextOption.Flags
    ...
    def setFlags(self, flags: 'QTextOption.Flags') -> None: ...
    def setAlignment(self, aalignment: QtCore.Qt.Alignment) -> None: ...
    def useDesignMetrics(self) -> bool: ...
    def setUseDesignMetrics(self, b: bool) -> None: ...
