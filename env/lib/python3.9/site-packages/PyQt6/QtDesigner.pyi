...
class QDesignerActionEditorInterface(QtWidgets.QWidget):
    ...
    def __init__(self, parent: QtWidgets.QWidget, flags: QtCore.Qt.WindowFlags = ...) -> None: ...
...
class QDesignerFormWindowInterface(QtWidgets.QWidget):
    ...
    class Feature(enum.Flag):
        EditFeature = ... # type: QDesignerFormWindowInterface.Feature
        GridFeature = ... # type: QDesignerFormWindowInterface.Feature
        TabOrderFeature = ... # type: QDesignerFormWindowInterface.Feature
        DefaultFeature = ... # type: QDesignerFormWindowInterface.Feature
...
class QDesignerFormWindowManagerInterface(QtCore.QObject):
    ...
    def core(self) -> QDesignerFormEditorInterface: ...
    def createFormWindow(self, parent: typing.Optional[QtWidgets.QWidget] = ..., flags: QtCore.Qt.WindowFlags = ...) -> QDesignerFormWindowInterface: ...
