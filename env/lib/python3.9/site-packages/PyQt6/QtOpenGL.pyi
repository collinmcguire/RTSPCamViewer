...
class QOpenGLBuffer(PyQt6.sip.simplewrapper):
    ...
    class RangeAccessFlags(enum.Flag):
        RangeRead = ... # type: QOpenGLBuffer.RangeAccessFlags
        RangeWrite = ... # type: QOpenGLBuffer.RangeAccessFlags
        RangeInvalidate = ... # type: QOpenGLBuffer.RangeAccessFlags
        RangeInvalidateBuffer = ... # type: QOpenGLBuffer.RangeAccessFlags
        RangeFlushExplicit = ... # type: QOpenGLBuffer.RangeAccessFlags
        RangeUnsynchronized = ... # type: QOpenGLBuffer.RangeAccessFlags
    ...
    def mapRange(self, offset: int, count: int, access: 'QOpenGLBuffer.RangeAccessFlags') -> PyQt6.sip.voidptr: ...
    def unmap(self) -> bool: ...
...
class QOpenGLDebugMessage(PyQt6.sip.simplewrapper):
    ...
    class Severities(enum.Flag):
        InvalidSeverity = ... # type: QOpenGLDebugMessage.Severities
        HighSeverity = ... # type: QOpenGLDebugMessage.Severities
        MediumSeverity = ... # type: QOpenGLDebugMessage.Severities
        LowSeverity = ... # type: QOpenGLDebugMessage.Severities
        NotificationSeverity = ... # type: QOpenGLDebugMessage.Severities
        AnySeverity = ... # type: QOpenGLDebugMessage.Severities

    class Types(enum.Flag):
        InvalidType = ... # type: QOpenGLDebugMessage.Types
        ErrorType = ... # type: QOpenGLDebugMessage.Types
        DeprecatedBehaviorType = ... # type: QOpenGLDebugMessage.Types
        UndefinedBehaviorType = ... # type: QOpenGLDebugMessage.Types
        PortabilityType = ... # type: QOpenGLDebugMessage.Types
        PerformanceType = ... # type: QOpenGLDebugMessage.Types
        OtherType = ... # type: QOpenGLDebugMessage.Types
        MarkerType = ... # type: QOpenGLDebugMessage.Types
        GroupPushType = ... # type: QOpenGLDebugMessage.Types
        GroupPopType = ... # type: QOpenGLDebugMessage.Types
        AnyType = ... # type: QOpenGLDebugMessage.Types

    class Sources(enum.Flag):
        InvalidSource = ... # type: QOpenGLDebugMessage.Sources
        APISource = ... # type: QOpenGLDebugMessage.Sources
        WindowSystemSource = ... # type: QOpenGLDebugMessage.Sources
        ShaderCompilerSource = ... # type: QOpenGLDebugMessage.Sources
        ThirdPartySource = ... # type: QOpenGLDebugMessage.Sources
        ApplicationSource = ... # type: QOpenGLDebugMessage.Sources
        OtherSource = ... # type: QOpenGLDebugMessage.Sources
        AnySource = ... # type: QOpenGLDebugMessage.Sources
    ...
    def type(self) -> 'QOpenGLDebugMessage.Types': ...
    def source(self) -> 'QOpenGLDebugMessage.Sources': ...
...
class QOpenGLShader(QtCore.QObject):
    ...
    class ShaderType(enum.Flag):
        Vertex = ... # type: QOpenGLShader.ShaderType
        Fragment = ... # type: QOpenGLShader.ShaderType
        Geometry = ... # type: QOpenGLShader.ShaderType
...
class QOpenGLShaderProgram(QtCore.QObject):
    ...
    def addCacheableShaderFromSourceFile(self, type: QOpenGLShader.ShaderType, fileName: str) -> bool: ...
    @typing.overload
    def addCacheableShaderFromSourceCode(self, type: QOpenGLShader.ShaderType, source: QtCore.QByteArray) -> bool: ...
    @typing.overload
    def addCacheableShaderFromSourceCode(self, type: QOpenGLShader.ShaderType, source: str) -> bool: ...
    def create(self) -> bool: ...
    ...
    def addShaderFromSourceFile(self, type: QOpenGLShader.ShaderType, fileName: str) -> bool: ...
    @typing.overload
    def addShaderFromSourceCode(self, type: QOpenGLShader.ShaderType, source: QtCore.QByteArray) -> bool: ...
    @typing.overload
    def addShaderFromSourceCode(self, type: QOpenGLShader.ShaderType, source: str) -> bool: ...
...
class QOpenGLTexture(PyQt6.sip.simplewrapper):
    ...
    class Features(enum.Flag):
        ImmutableStorage = ... # type: QOpenGLTexture.Features
        ImmutableMultisampleStorage = ... # type: QOpenGLTexture.Features
        TextureRectangle = ... # type: QOpenGLTexture.Features
        TextureArrays = ... # type: QOpenGLTexture.Features
        Texture3D = ... # type: QOpenGLTexture.Features
        TextureMultisample = ... # type: QOpenGLTexture.Features
        TextureBuffer = ... # type: QOpenGLTexture.Features
        TextureCubeMapArrays = ... # type: QOpenGLTexture.Features
        Swizzle = ... # type: QOpenGLTexture.Features
        StencilTexturing = ... # type: QOpenGLTexture.Features
        AnisotropicFiltering = ... # type: QOpenGLTexture.Features
        NPOTTextures = ... # type: QOpenGLTexture.Features
        NPOTTextureRepeat = ... # type: QOpenGLTexture.Features
        Texture1D = ... # type: QOpenGLTexture.Features
        TextureComparisonOperators = ... # type: QOpenGLTexture.Features
        TextureMipMapLevel = ... # type: QOpenGLTexture.Features
