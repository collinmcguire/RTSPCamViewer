...
class QSqlQuery(PyQt6.sip.simplewrapper):
    ...
    def addBindValue(self, val: typing.Any, type: 'QSql.ParamType' = ...) -> None: ...
    @typing.overload
    def bindValue(self, placeholder: str, val: typing.Any, type: 'QSql.ParamType' = ...) -> None: ...
    @typing.overload
    def bindValue(self, pos: int, val: typing.Any, type: 'QSql.ParamType' = ...) -> None: ...
...
class QSqlQueryModel(QtCore.QAbstractTableModel):
    ...
    def setHeaderData(self, section: int, orientation: QtCore.Qt.Orientations, value: typing.Any, role: int = ...) -> bool: ...
    def headerData(self, section: int, orientation: QtCore.Qt.Orientations, role: int = ...) -> typing.Any: ...
...
class QSql(PyQt6.sip.simplewrapper):
    ...
    class ParamType(enum.Flag):
        In = ... # type: QSql.ParamType
        Out = ... # type: QSql.ParamType
        InOut = ... # type: QSql.ParamType
        Binary = ... # type: QSql.ParamType
